  ...
  ({ className = '', label, error, helperText, ...props }, ref) => {
    return (
      <div className="w-full">
        ...
        <textarea
          ref={ref}
          className={`w-full min-h-[80px] p-3 bg-ops-bg-surface border rounded-ops-sm text-ops-sm placeholder:text-ops-text-muted focus:outline-none transition-colors resize-y
            ${error 
